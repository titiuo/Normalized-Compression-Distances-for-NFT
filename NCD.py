...
def getCollection(collection_name):
    '''récupérer les données de la collection, images et prix'''
    dict = {}
...
def ncd(x,y):
    '''calculer la distance NCD entre 2 images de NFT'''
...
def len_dict(collection_name):
    '''renvoie la taille du dictionnaire enregistré'''
...
def see_in_dict(collection_name,id):
    '''renvoie l'image et le prix du NFT numéro id enregisté dans le dictionnaire'''
    with open(collection_name,'rb') as f:
        collection_dict = pickle.load(f)
